...
export const metadata: Metadata = {
  title: "טיפול בגמגום ושיקום קולי | קליניקה במודיעין - יקיר כהן",
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-xl text-zinc-600 leading-relaxed mb-10 max-w-lg">
              הטיפול בגמגום הוא לא רק טכניקה, הוא מסע להחזרת הביטחון בקול שלך. אנו משתמשים בכלים מעולם הסאונד והמוזיקה כדי ליצור חוויה טיפולית מעצימה.
            </p>
      ...
      <section className="py-24 px-6 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="p-10 bg-white border border-zinc-100 rounded-2xl shadow-sm hover:border-brand-red transition-all">
            ...
            <p className="text-zinc-500 leading-relaxed">שימוש בציוד הקלטה מקצועי כדי לשקף לתלמיד את קולו ולשפר את השטף בזמן אמת.</p>
          </div>
          <div className="p-10 bg-white border border-zinc-100 rounded-2xl shadow-sm hover:border-brand-red transition-all">
          ...
          <div className="p-10 bg-white border border-zinc-100 rounded-2xl shadow-sm hover:border-brand-red transition-all">
            ...
            <p className="text-zinc-500 leading-relaxed">כל טיפול מותאם בדיוק לקצב וליכולות של המטופל, באווירה תומכת ולא שיפוטית.</p>
          </div>
        </div>
      </section>
    </div>
