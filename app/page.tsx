...
export const metadata: Metadata = {
  title: "יקיר כהן הפקות | אולפן הקלטות במודיעין ופיתוח קול מקצועי",
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          <article className="lg:col-span-7 flex flex-col gap-8">
            ...
            <p className="text-xl text-zinc-600 leading-relaxed max-w-2xl">
              ברוכים הבאים למרחב שבו יצירה פוגשת מקצוענות. באולפני יקיר כהן, אנו משלבים ציוד קצה עם ידע קליני מעמיק בתחום הדיבור והקול. בין אם אתם מחפשים <strong>אולפן הקלטות במודיעין</strong> להפקת להיט או תהליך של <strong>טיפול בגמגום במודיעין</strong>, הגעתם למקום הנכון.
            </p>
